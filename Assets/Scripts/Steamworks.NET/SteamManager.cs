...
#if !(UNITY_STANDALONE_WIN || UNITY_STANDALONE_LINUX || UNITY_STANDALONE_OSX || STEAMWORKS_WIN || STEAMWORKS_LIN_OSX) || FORCE_DISABLE_STEAMWORKS
...
public class SteamManager : MonoBehaviour {
	...
	protected virtual void Awake() {
		...
		try {
			...
			if (SteamAPI.RestartAppIfNecessary(new AppId_t(1556840))) {
