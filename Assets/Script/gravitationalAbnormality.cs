...
public class gravitationalAbnormality : BBASS_MentBASE
{
    ...
    IEnumerator BBASSMentFrist()
    {
        ...
        isPlay = true;
        dialogTexts.Add(new DialogData("여기서 부터 몇몇의 방들이"));
        dialogTexts.Add(new DialogData("중력 이상으로 인해 중력이 약해져 몸을 움직이기 힘들 수 있습니다"));
        dialogTexts.Add(new DialogData("조심하시길 바랍니다"));
